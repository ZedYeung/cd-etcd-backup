...
SLEEP_TIME=$[${TEST_FULL_NUM} * ${FULL_INTERVAL} + ${TEST_DIFF_NUM} * ${DIFF_INTERVAL} + ${CUSHION_INTERVAL}]
...
DIFF_BACKUP_TEST_CASE_NUM=$[ (${TEST_FULL_NUM} * ${FULL_INTERVAL} + ${TEST_DIFF_NUM} * ${DIFF_INTERVAL}) / ${GENERATE_INTERVAL}]
